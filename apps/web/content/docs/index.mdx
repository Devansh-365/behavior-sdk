---
title: Introduction
description: nyasa is a browser SDK that classifies every session as human, authorized agent, or unauthorized bot in real time.
---
...
- Runs detection rules client-side whenever you call `flush()` or when an underlying `<form>` submits.
